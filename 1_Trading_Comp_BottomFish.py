    ...
    with requests.Session() as s:
        ...
        while 5 <= tick <= 300:
            ...
            if len(orders) < 12:
                ...
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'BBSN', 'type': 'LIMIT', 'quantity': 5000, 'action': 'SELL', 'price': 75.00})
                ...
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'BBSN', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 50.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'BBSN', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 45.50})
