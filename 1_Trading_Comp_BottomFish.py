    ...
    with requests.Session() as s:
        ...
        while 5 <= tick <= 300:
            ...
            if len(orders) < 12:
                ...
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'CRZY', 'type': 'LIMIT', 'quantity': 5000, 'action': 'SELL', 'price': 14.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'CRZY', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 8.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'CRZY', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 6.00})

                s.post('http://localhost:9999/v1/orders', params={'ticker': 'TAME', 'type': 'LIMIT', 'quantity': 5000, 'action': 'SELL', 'price': 30.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'TAME', 'type': 'LIMIT', 'quantity': 5000, 'action': 'SELL', 'price': 33.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'TAME', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 20.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'TAME', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 18.00})

                s.post('http://localhost:9999/v1/orders', params={'ticker': 'BBSN', 'type': 'LIMIT', 'quantity': 5000, 'action': 'SELL', 'price': 70.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'BBSN', 'type': 'LIMIT', 'quantity': 5000, 'action': 'SELL', 'price': 65.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'BBSN', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 52.00})
                s.post('http://localhost:9999/v1/orders', params={'ticker': 'BBSN', 'type': 'LIMIT', 'quantity': 5000, 'action': 'BUY', 'price': 47.50})
