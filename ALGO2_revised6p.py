    ...
    with requests.Session() as s:
        ...
        while 5 <= tick <= 300:
           ...
           # if len(orders['bids']['trader_id']) == '123':
            ...
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close  , 'quantity': 2750, 'action': 'BUY'})
                
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close , 'quantity': 1750, 'action': 'BUY'})
                
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close , 'quantity': 1750, 'action': 'BUY'})
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close  , 'quantity': 1250, 'action': 'BUY'})
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close  , 'quantity': 1250, 'action': 'BUY'})
            #     sleep(1)
            ...
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close , 'quantity': 2750, 'action': 'SELL'})
                
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close  , 'quantity': 1750, 'action': 'SELL'})
                
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close , 'quantity':1750, 'action': 'SELL'})
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close , 'quantity': 1250, 'action': 'SELL'})
            #     s.post('http://localhost:9999/v1/orders', params={'ticker': 'ALGO', 'type': 'LIMIT', 'price': algo_close  , 'quantity': 1250, 'action': 'SELL'})
            #     sleep(1)
